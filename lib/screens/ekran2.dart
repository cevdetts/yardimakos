...
class Ekran2 extends StatelessWidget {
  ...
  List<String> userquotes = [
    ...
    "Tedavim çok rahat geçti",
    "Harika sohbeti ve tedavi anlayışı ile süper",
    "Teşekkürler",
  ];
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    "Dr.Büşra Çakar, Baltalimanı Kemik Hastalıkları Eğitim ve Araştırma Hastanesi'de başarılı bir Fizik Tedavi ve Kemik Uzmanıdır.",
                    style: TextStyle(
                      fontSize: 16,
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                        "Baltalimanı, Balta Limanı Hisar Cd. No:56, 34470 Sarıyer/İstanbul"),
                  ),
                ],
              ),
            ),
